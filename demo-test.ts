...
async function createTodoForAJ() {
  try {
    ...
    process.stdout.write(`View on Walrus scanner: https://walrus-testnet.chainlensexplorer.com/blob/${blobId}\n`);
    ...
    if (updatedList) {
      ...
      process.stdout.write(`View list on Walrus scanner: https://walrus-testnet.chainlensexplorer.com/blob/${listBlobId}\n`);
    }
