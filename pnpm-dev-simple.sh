...
print_info "  cd $(pwd)"
print_info "  export NODE_ENV=development"
print_info "  export API_PORT=3001"
print_info "  export API_HOST=localhost"
print_info "  export CORS_ORIGIN=http://localhost:3000"
print_info "  ./bin/waltodo serve --port 3001 --dev"
print_info ""
print_info "This will start the integrated API server on http://localhost:3001"
print_info ""
...
print_info "  export NEXT_PUBLIC_API_URL=http://localhost:3001"
print_info "  export NEXT_PUBLIC_WS_URL=ws://localhost:3001"
print_info "  export PORT=3000"
print_info "  pnpm dev"
print_info ""
