...
async function testAIFailureScenarios() {
  ...
  try {
    ...
    process.stdout.write(
      '1. Testing core operations without AI environment...\n'
    );
    ...
    process.stdout.write(
      `   ✅ Core operations work perfectly without AI environment\n\n`
    );

    // Test 2: AI commands with invalid credentials don't crash
    process.stdout.write(
      '2. Testing AI commands with invalid credentials...\n'
    );
    ...
    try {
      ...
      process.stdout.write(
        `   ✅ System continues to operate with invalid AI credentials\n`
      );
      ...
      process.stderr.write(
        `   ❌ AI credential failure crashed system: ${error}\n`
      );
      throw error;
    }
    ...
    process.stdout.write(
      `   ✅ All CLI operations work independently of AI\n\n`
    );
    ...
    process.stdout.write(
      `   ✅ System state consistent: ${finalLists.length} lists, ${finalTodos.length} todos\n`
    );
    ...
    process.stdout.write('===================================\n');
    process.stdout.write(
      '✅ Core system is completely resilient to AI failures\n'
    );
    process.stdout.write(
      '✅ AI services are properly isolated from core functionality\n'
    );
    process.stdout.write(
      '✅ System gracefully handles all AI error conditions\n'
    );
    process.stdout.write('✅ Data integrity maintained during AI failures\n');
    process.stdout.write(
      '✅ User can continue working when AI is unavailable\n'
    );
  } catch (error) {
