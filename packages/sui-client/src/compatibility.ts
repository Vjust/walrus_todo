 ...
 */
export function isVersionAtLeast(current: VersionInfo, required: VersionInfo): boolean {
 ...
 */
export function createCompatibleSuiClientOptions(options: any): any {
 ...
 */
export function normalizeTransactionResult(result: any): any {
 ...
 */
export function normalizeOwnedObjectsResponse(response: any): any {
 ...
 */
export function normalizeObjectResponse(response: any): any {
...
/**
 * Feature detection for different SDK capabilities
 */
export interface SDKCapabilities {
  ...
  hasTransactionMetadata: boolean;
}

/**
 * Detect SDK capabilities based on version
 */
export function detectSDKCapabilities(): SDKCapabilities {
  const suiVersion = getSuiVersion();
...
export const ReactCompatibility = {
   ...
   */
  useSafeCurrentAccount: (useCurrentAccountHook: any) => {
    try {
   ...
   */
  useSafeWalletConnection: (useConnectWalletHook: any) => {
    try {
   ...
   */
  useSafeTransactionExecution: (useSignAndExecuteTransactionHook: any) => {
    try {
