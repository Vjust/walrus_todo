...
import { useSuiTodos, useTodoOperation, NetworkType, Todo, CreateTodoParams, UpdateTodoParams } from '@/hooks/useSuiTodos';
...
function TodoItem({ todo, onUpdate, onComplete, onDelete, loading }: {
  todo: Todo;
...
function NetworkSwitcher({ currentNetwork, onSwitch, disabled }: {
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="flex justify-between items-center">
          <div className="text-sm text-gray-600">
            <p>Connected: <code className="bg-gray-100 px-2 py-1 rounded">{address}</code></p>
            <p>Network: {network} {state.networkHealth ? '✅' : '❌'}</p>
          </div>
