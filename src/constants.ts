...
export const RETRY_CONFIG = {
  ATTEMPTS: getEnv('RETRY_ATTEMPTS' as any) || 5,
  DELAY_MS: getEnv('RETRY_DELAY_MS' as any) || 500,
  MAX_DELAY_MS: getEnv('MAX_RETRY_DELAY_MS' as any) || 60000,
  TIMEOUT_MS: getEnv('TIMEOUT_MS' as any) || 15000,
  MAX_DURATION_MS: getEnv('MAX_RETRY_DURATION' as any) || 300000,
  RETRYABLE_ERRORS: [
    'ETIMEDOUT',
    'ECONNRESET',
    'ECONNREFUSED',
...
export const CONNECTION_CONFIG = {
  TIMEOUT_MS: getEnv('CONNECTION_TIMEOUT_MS' as any) || 30000,
  KEEP_ALIVE: getEnv('CONNECTION_KEEP_ALIVE' as any) || false,
  MAX_IDLE_TIME_MS: getEnv('CONNECTION_MAX_IDLE_TIME_MS' as any) || 60000,
  AUTO_RECONNECT: getEnv('CONNECTION_AUTO_RECONNECT' as any) || true,
  RETRY_CONFIG: {
    MAX_RETRIES: getEnv('CONNECTION_MAX_RETRIES' as any) || 3,
    BASE_DELAY_MS: getEnv('CONNECTION_BASE_DELAY_MS' as any) || 1000,
    MAX_DELAY_MS: getEnv('CONNECTION_MAX_DELAY_MS' as any) || 10000,
  },
} as const;
