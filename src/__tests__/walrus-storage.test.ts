...
describe('WalrusStorage', () => {
  ...
  beforeEach(() => {
    ...
    mockWalrusClient.writeBlob.mockResolvedValue({ blobId: '', blobObject: {} as BlobObject });
    ...
    mockWalrusClient.getStorageUsage.mockResolvedValue({ used: '100000', total: '1000000' });
