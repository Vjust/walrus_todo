...
describe('Consolidated TodoService', () => {
  ...
  describe('createList', () => {
    ...
    it('should throw an error if the list already exists', async () => {
      ...
      await expect(todoService.createList('existingList', 'newOwner'))
  ...
  describe('addTodo', () => {
    ...
    it('should create a list if it does not exist', async () => {
      ...
      const getListMock = jest.spyOn(todoService, 'getList')
  ...
  describe('findTodoById', () => {
    it('should find a todo by ID across all lists', async () => {
      ...
      jest.spyOn(todoService, 'getAllLists').mockResolvedValue(['list1', 'list2']);
      
      // Mock getList to return lists with todos
      jest.spyOn(todoService, 'getList')
        .mockResolvedValueOnce({
          id: '123',
          name: 'list1',
          owner: 'owner',
          todos: [
            { id: '111', title: 'Todo 1', completed: false, createdAt: '', updatedAt: '', private: true },
            { id: '222', title: 'Todo 2', completed: false, createdAt: '', updatedAt: '', private: true }
          ],
          version: 1,
          createdAt: '',
          updatedAt: ''
        ...
        .mockResolvedValueOnce({
          ...
          owner: 'owner',
          todos: [
            { id: '333', title: 'Todo 3', completed: false, createdAt: '', updatedAt: '', private: true },
            { id: '444', title: 'Todo 4', completed: false, createdAt: '', updatedAt: '', private: true }
          ],
          version: 1,
          createdAt: '',
          updatedAt: ''
