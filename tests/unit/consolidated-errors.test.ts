...
describe('Consolidated Error Types', () => {
  ...
  describe('BaseError', () => {
    ...
    it('should correctly redact identifiers with first 6 and last 4 characters', () => {
      ...
      expect(testError.testRedactIdentifier('0x1234567890abcdef')).toBe('0x1234...cdef');
      expect(testError.testRedactIdentifier('0x7777888899990000aaaabbbbccccdddd')).toBe('0x7777...dddd');
      expect(testError.testRedactIdentifier('1234567890abcdef1234567890abcdef')).toBe('123456...cdef');
  ...
  describe('TransactionError', () => {
    it('should sanitize transaction-specific fields', () => {
      ...
      expect(error.transactionHash).toBe('0x1234567890abcdef1234567890abcdef12345678901234567890abcdef123456');
      expect(error.contractAddress).toBe('0xabcdef1234567890abcdef1234567890abcdef12');
    ...
    it('should sanitize transaction hashes in factory methods', () => {
      const error = TransactionError.reverted('Out of gas', {
        transactionHash: '0x7777888899990000111122223333444455556666777788889999000011112222',
        methodName: 'transfer',
        context: {
      ...
      expect(error.transactionHash).toBe('0x7777888899990000111122223333444455556666777788889999000011112222');
