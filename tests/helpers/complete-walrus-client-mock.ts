...
export function getMockWalrusClient(): CompleteWalrusClientMock {
  ...
  return {
    getConfig: jest
      .fn()
      .mockImplementation(() => Promise.resolve(createMockConfig())),
    getWalBalance: jest.fn().mockResolvedValue('1000'),
    getStorageUsage: jest
      .fn()
      .mockImplementation(() => Promise.resolve(createMockStorageUsage())),
    readBlob: jest
      .fn()
      .mockImplementation(() => Promise.resolve(createMockBlob())),
    writeBlob: jest.fn().mockImplementation(() =>
      Promise.resolve({
    ...
    getBlobInfo: jest.fn().mockImplementation(() =>
      Promise.resolve({
        blob_id: 'mock-blob-test-todo-id',
        certified_epoch: 150,
        registered_epoch: 100,
    ...
    getBlobObject: jest.fn().mockImplementation(() =>
      Promise.resolve({
        id: { id: 'mock-blob-test-todo-id' },
        blob_id: 'mock-blob-test-todo-id',
        registered_epoch: 100,
    ...
    getBlobMetadata: jest.fn().mockImplementation(() =>
      Promise.resolve({
        V1: {
          encoding_type: { RedStuff: true, $kind: 'RedStuff' },
          unencoded_length: '4', // Match default blob size
...
export function createWalrusModuleMock() {
  return {
    ...
    createWalrusClient: jest
      .fn()
      .mockImplementation(() => getMockWalrusClient()),
  };
}
